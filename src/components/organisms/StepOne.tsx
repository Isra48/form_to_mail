...
export const StepOne = ({ fullName, onChange }: Props) => (
  <section className="bg-luxury-texture rounded p-6 md:p-10">
    ...
    <h2 className="mt-3 font-headline text-4xl font-light md:text-6xl">Bienvenido a <em className="text-primary">The Grand Aethel</em></h2>
